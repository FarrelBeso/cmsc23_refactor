            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'USERNAME', // provider.currentuser?.username ?? 'N/A',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text('N/A'), //provider.currentuser?.id ?? 'N/A')
              ],
            ),
          ),
          Card(
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(DateFormat(DateFormat.YEAR_MONTH_DAY).format(DateTime(
                      1900))) //provider.currentuser?.birthday ?? DateTime(1900)))
                ],
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text('N/A'), //provider.currentuser?.location ?? 'N/A')
                ],
              ),
            ),
          ),
